...
using CrudMvcBarang.Data;
using CrudMvcBarang.Models;

namespace CrudMvcBarang.Controllers
{
    public class BarangsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NamaBarang,Harga,Stok")] Barang barang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NamaBarang,Harga,Stok")] Barang barang)
        {
            if (id != barang.Id)
            {
                return NotFound();
